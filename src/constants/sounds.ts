...
export const SOUNDS: Sound[] = [
  ...
  { id: 'gentle_rainfall', name: 'Gentle Rainfall', file: 'gentle-rainfall.mp3', category: 'nature', emoji: '🌦️', popular: true },
  ...
  { id: 'soft_wind', name: 'Soft Wind', file: 'soft-wind-with-birds.mp3', category: 'nature', emoji: '🍃', popular: true },
